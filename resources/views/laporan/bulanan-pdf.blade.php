...
<body>
    <div class="header">
        <h2>LAPORAN TRANSAKSI PENJUALAN BULANAN</h2>
    ...
    <h3>Detail Transaksi Per Tanggal</h3>
    @foreach ($data_per_tanggal as $perTanggal)
        <div class="tanggal-section">
            <div class="tanggal-header">
                <strong>{{ date("d F Y", strtotime($perTanggal["tanggal"])) }}</strong> |
                Transaksi: {{ $perTanggal["total_transaksi"] }} |
                ...
                <div style="margin-bottom: 15px; page-break-inside: avoid;">
                    <table class="transaksi">
                        <tr>
                            ...
                            <td width="150"><strong>Waktu</strong></td>
                            <td>{{ date("H:i", strtotime($transaksi["tgl_transaksi"])) }}</td>
                        </tr>
                        <tr>
